 ...
 * 
 * 
 * close() method in AutoCloseable interface declares to throw Exception
 * (checked exception) and hence handle or declare rule must be followed.
 * 
 * 
 * 
 * As main method neither declares to throw Exception nor provides catch block
 * for Exception type, hence try-with-resources statement causes compilation
 * error.
 */