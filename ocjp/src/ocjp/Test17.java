...
/*
 * TreeSet requires you to provide either Comparable or Comparator. NOTE: To be
 * used with TreeSet, it is not needed to override equals(Object) and hashCode()
 * methods.
 * 
 * 
 * 
 ...
 * 
 * 
 * In this case 'new TreeSet<>(Student::compareByName);' provides the instance
 * of Comparator<Student> type, which compares the names only.
 * 
